...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        String text = "http://YOUR_SERVER_IP:8088";
        //不含Logo
//        QRCodeUtil.encode(text, null, "/path/to/output", "qrcode", true);
        //含Logo，指定二维码图片名
        QRCodeUtil.encode(text, "/path/to/output/宋康.jpg", "/path/to/output", "qrcode1", true);
//        System.out.println(QRCodeUtil.decode("d:\\cc\\qrcode1.jpg"));
//        System.out.println(QRCodeUtil.encode(text, null, "/path/to/output", "qrcode", true));
    }
}
