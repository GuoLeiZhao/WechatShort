...
public class WxServiceImpl implements WxService {
    ...
    @Override
    public Result payMoney(BigDecimal money,Long userId, Integer classify, Long courseId, Long courseDetailsId) throws Exception {
        ...
        try {
            ...
            return pay(money.doubleValue(),classify, userId, generalOrder);
        } finally {
    ...
    public boolean refund(Orders orders){
        ...
        int commInfoId = 0;
        Integer payWay = orders.getPayWay(); //支付方式（1app微信 2微信公众号 3微信小程序 4app支付宝 5H5支付宝 6看点）
        switch (payWay){
