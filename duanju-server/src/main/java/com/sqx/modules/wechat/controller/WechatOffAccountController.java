package com.sqx.modules.wechat.controller;


import cn.binarywang.wx.miniapp.api.WxMaService;
import cn.binarywang.wx.miniapp.bean.WxMaMessage;
import cn.binarywang.wx.miniapp.constant.WxMaConstants;
import com.sqx.config.WxMaConfiguration;
...
@RequestMapping(value = "/wechat/office_account")
@RequiredArgsConstructor
public class WechatOffAccountController {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @GetMapping("/authGet/{appid}")
    ...
    @PostMapping(value = "/post/{appid}",produces = "application/xml; charset=UTF-8")
